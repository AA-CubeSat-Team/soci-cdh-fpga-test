...
## 
## Makefile     : fsw_lib.mk
## Generated on : Thu Mar 07 16:08:35 2019
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = fsw_lib_ref.rsp
...
INCLUDES_BUILDINFO = -I$(START_DIR)/fsw_lib_ert_rtw -I$(START_DIR) -I$(START_DIR)/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include
...
DEFINES_STANDARD = -DMODEL=fsw_lib -DNUMST=4 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/fsw_lib_ert_rtw/fsw_lib.c $(START_DIR)/fsw_lib_ert_rtw/fsw_lib_data.c
